...
// Methods
ContactCustomFieldSchema.methods.validateValue = function (value: any): boolean {
...
ContactCustomFieldSchema.methods.formatValue = function (value: any): any {
  if (value === undefined || value === null || value === '') {
...
// Indexes
ContactCustomFieldSchema.index({ name: 1 }, { unique: true });
ContactCustomFieldSchema.index({ isActive: 1 });
ContactCustomFieldSchema.index({ type: 1 });
ContactCustomFieldSchema.index({ required: 1 });

export default mongoose.models.ContactCustomField || mongoose.model<IContactCustomField>('ContactCustomField', ContactCustomFieldSchema);
